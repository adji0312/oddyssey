...
@section('container')
    <div class="d-flex m-3 justify-content-between">
        <div class="card position-sticky" style="width: 18rem;">
        ...
        <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="https://wallpapercave.com/wp/wp5171877.jpg" class="d-block" alt="..." width="700px">
                </div>
    ...
    <br>
    <h4 class="m-3">More Like This</h4>
    <div class="d-flex justify-content-between m-3">
        {{-- DISINI TINGGAL LOOPING 3x UNTUK GAME YANG KATEGORI NYA SAMA --}}
        <div class="text-end">
            <img src="https://wallpapercave.com/wp/wp5171877.jpg" alt="..." width="350px">
    ...
    <br>
    {{-- COMMENT SECTION --}}
    <div class="card m-3" style="width: 68rem;">
        <div class="card-body">
